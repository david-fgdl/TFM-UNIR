...
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    public string ReadFile(string file_path)
    {
        ...
        string file_info = null;  // String que almacenará la información del archivo (Por defecto null)

        StreamReader file_stream_reader = new StreamReader(file_path);  // Creación del StreamReader correspondiente al archivo cuyo nombre se pasa por parámetro
        ...
        return file_info;  // Devolución del contenido del archivo en forma de string
    ...
    public string [] ReadFileLineByLine(string file_path)
    {
        ...
        string[] file_lines = null;  // String que almacenará la información del archivo (Por defecto " | ")

        file_lines = File.ReadAllLines(file_path);  // Lectura del arcihvo de inicio a fin

        return file_lines;  // Devolución del contenido del archivo en forma de string
